...
from pengwin_inference.inference import run_case
...
def main():
    ...
    frag = FragmentPredictor(args.model, fold=args.fold, click_layout=args.click_layout,
                             device=device, use_mirroring=args.tta)
    anat = (AnatomyPredictor(args.anatomy_model, fold=args.fold, device=device, use_mirroring=args.tta)
